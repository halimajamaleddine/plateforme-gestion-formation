                    ...
                    <div class="card border shadow-xs mb-4">
                        <div class="card-header border-bottom pb-0">
                            <div class="d-sm-flex align-items-center">
                                <div>
                                    <h6 class="font-weight-semibold text-lg mb-0">Liste des inscries</h6>
                                    <p class="text-sm">Voir les informations sur tous les membres</p>
                                </div>
                                ...
                                <table class="table align-items-center mb-0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <p class="text-sm text-dark font-weight-semibold mb-0">{{$formateur->telephone}}</p>
                                                <p class="text-sm text-secondary mb-0">{{$formateur->role}}</p>
                                            </td>
